...
def plot_trajectory_evolution(ax: plt.axes, states_car_1: np.ndarray, states_car_2: np.ndarray, title: str, gifname: str) -> (plt.axes):
    ...
    if len(states_car_1.shape) == 3:
        ...
        for i in range(10, l):
            ...
            plot_track_boundaries(ax, waypoints[105:280])
            # plot_track_boundaries(ax, waypoints[1150:1400])
            # plot_track_boundaries(ax, waypoints[1150:1350])
            for j in range(d):
...
# for i in range(5):
#     # f, ax = plt.subplots()
#     # ax = plot_track_boundaries(ax, waypoints[1100:1350])
#     # ax = plot_trajectory_evolution(ax, car1_states_all[:, :, i], car2_states_all[:, :, i],
#     # 'Trajectory Plot - GTC v/s GTC', ['Car 1', 'Car 2'],
#     # '../../GIFS/GTC_vs_GTC/scene1_{}_traj.gif'.format(i+1))
#     # plt.close()

#     # f, ax = plt.subplots()
#     # ax = plot_velocity_evolution(ax, car1_states_all[:, :, i], car2_states_all[:, :, i],
#     # 'Velocity Plot - GTC v/s GTC', ['Car 1', 'Car 2'],
#     # '../../GIFS/GTC_vs_GTC/scene1_{}_vel.gif'.format(i+1))
#     # plt.close()

#     f, (ax1, ax2) = plt.subplots(2, 1)
#     ax1 = plot_track_boundaries(ax1, waypoints[80:350])
