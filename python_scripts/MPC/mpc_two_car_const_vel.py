...
def main():
    try:
        ...
        # Save all Dataclass object lists to a file
            save_log('../../Data/states_1_mpc.pickle', env.states_1)
            save_log('../../Data/controls_1_mpc.pickle', env.controls_1)
            save_log('../../Data/states_2_mpc.pickle', env.states_2)
            save_log('../../Data/controls_2_mpc.pickle', env.controls_2)
